...
def open_github(event):
    url = "https://github.com/muzammilvmx/Grass_bot"
    subprocess.Popen(['start', url], shell=True)

def open_referral(event):
    url = "https://app.getgrass.io/register/?referralCode=njvKNaXUCdW4xdL"
    subprocess.Popen(['start', url], shell=True)
...
if __name__ == '__main__':
    ...
    github_label = tk.Label(labels_frame, text="GitHub Repository: https://github.com/muzammilvmx/Grass_bot    ", fg="blue")
    github_label.pack(side=tk.LEFT)

    referral_label = tk.Label(labels_frame, text="Referral Link: https://app.getgrass.io/register/?referralCode=njvKNaXUCdW4xdL", fg="red")
    ...
    log_box.insert(tk.END, 'Socks5 Proxy format: socks5://username:password@ip:port\n', 'info')
